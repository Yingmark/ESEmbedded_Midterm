...
void set_sysclk_pll(void)
{
	...
	//set pll
	CLEAR_BIT(RCC_BASE + RCC_PLLCFGR_OFFSET,PLLSRC_BIT);
 //use HSE for PLL source
	...
	WRITE_BITS(RCC_BASE + RCC_PLLCFGR_OFFSET, PLLM_5_BIT, PLLM_0_BIT, 0b0001000);	//8
	...
	//use pll
	WRITE_BITS(RCC_BASE + RCC_CFGR_OFFSET, SWS_1_BIT, SWS_0_BIT, 0b10);	
